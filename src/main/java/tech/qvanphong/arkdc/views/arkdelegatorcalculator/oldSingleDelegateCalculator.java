...
@Tag("calculator-view")
@JsModule("./views/component/xsingle-delegate.js")
public class oldSingleDelegateCalculator extends PolymerTemplate<oldSingleDelegateCalculator.CalculatorViewModel> {
    ...
    public oldSingleDelegateCalculator(ArkDelegatesService delegatesService) {
